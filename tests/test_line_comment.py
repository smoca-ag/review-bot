...
class TestDeriveSeverity(unittest.TestCase):
    def _make_comment(self, risk_score: int, confidence_score: float) -> LineComment:
        return LineComment(
            ...
            falsification_method="execute_command: rg X src/",
...
class TestLineCommentModel(unittest.TestCase):
    def test_new_fields(self):
        c = LineComment(
            ...
            falsification_method="execute_command: rg 'sanitize.*password' src/",
            verification="confirmed",
    ...
    def test_single_line_no_end(self):
        c = LineComment(
            ...
            falsification_method="execute_command: rg usage src/",
