...
critic_agent_def = AgentDef(
    ...
    specialty_prompt=(
        ...
        "   - DROP if `false_positive_reasoning` is shorter than 20 characters (indicates low-effort analysis).\n"
        ...
        "5. CONTEXT REPORT: Use the context agent's report to populate `has_purpose`, `has_test_plan`, and `description_feedback`. Merge its findings with your own assessment of the PR description.\n"
        "6. SCHEMA POPULATION:\n"
        ...
        "7. NO INVENTION: Do not create new issues. Only filter, consolidate, and reframe provided findings.\n"
    ),
)
